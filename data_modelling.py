...
def main():
    ...
    query = """
        ...
        FROM
         top_tracks t1
        JOIN
         audio_features t2 ON t2.id = t1.id AND CAST(t1.dt AS DATE) = DATE('2020-05-28') AND CAST(t2.dt AS DATE) = DATE('2020-05-28')
...
def query_athena(query, athena):
    response = athena.start_query_execution(
        ...
        ResultConfiguration={
            'OutputLocation': "s3://athena-panomix-table/repair/",
